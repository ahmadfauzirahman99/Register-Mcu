...
<p>
    <a href="<?php echo Url::to(['view','id'=>$permintaan]) ?>" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
</p>
<strong>BIODATA</strong><hr>
<div class="row">
    <div class="col-md-3">
        <img src="<?php echo Url::to(['get-ktp','id'=>$model['u_id']]) ?>" style="height:auto; width:100%;">
    </div>
    <div class="col-md-9">
        <?= DetailView::widget([
            'model' => $model,
    ...
    function childKuisioner($model,$data,$tab=5,$c=false){
        ...
        foreach($data as $i){
            ...
            <tr>
                ...
                <td>
                    <?php
                    if(($i['k_id']>=46 && $i['k_id']<=53) || $i['k_id']==57 ){
                        echo $value!=NULL ? $value['uk_keterangan'] : '';
                    }else{
                        if($value!=NULL){
