...
<div class="well">
    ...
    if($daftar['u_finish_at']==NULL){
        ...
        <div class="jumbotron">
            ...
            <p>
                <a href="<?php echo Url::to(['selesai-bukti-pendaftaran']); ?>" target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Bukti Pendaftaran</a>
            </p>
        </div>
        <?php
    }
