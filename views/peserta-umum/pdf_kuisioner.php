...
<table class="tb" width="100%" border="1">
    ...
    <tbody>
        <?php if($u['kuisionerbiodata']['ukb_krj_sebelum']!=NULL): ?>
            ...
            <tr>
                <td align="left">Uraian Tugas<br><small>Uraian fungsi dan tanggungjawab dalam kegiatan pekerjaan</small></td>
                <td><?php echo $u['kuisionerbiodata']['ukb_sblm_utama_uraian'] ?></td>
                <td><?php echo $u['kuisionerbiodata']['ukb_sblm_tambah_uraian'] ?></td>
            </tr>
            <tr>
                <td align="left">Target Kerja<br><small>Sasaran yang telah ditetapkan untuk dicapai dalam suatu pekerjaan</small></td>
                <td><?php echo $u['kuisionerbiodata']['ukb_sblm_utama_target'] ?></td>
                <td><?php echo $u['kuisionerbiodata']['ukb_sblm_tambah_target'] ?></td>
            </tr>
            <tr>
                <td align="left">Cara Kerja<br><small>Tahapan yang dilakukan sehingga tercapai tujuan pekerjaan</small></td>
                <td><?php echo $u['kuisionerbiodata']['ukb_sblm_utama_cara'] ?></td>
                <td><?php echo $u['kuisionerbiodata']['ukb_sblm_tambah_cara'] ?></td>
            </tr>
            <tr>
                <td align="left">Alat Kerja<br><small>Benda yang digunakan untuk mengerjakan sesuatu untuk mempermudah pekerjaan</small></td>
...
<table class="tb" width="100%" border="1">
    ...
    <tbody>
        <?php echo AppUmum::pdfRiwayatSosial($kuisioner_sosial,5,false,$u); ?>
    </tbody>
</table>
<pagebreak />
<div class="title">
...
foreach($kategori_kuisioner as $kk){
    ...
    <table class="tb" width="100%" border="1">
        ...
        <tbody>
            <?php echo AppUmum::pdfRiwayatPenyakit($data,5,false,$u); ?>
        </tbody>
    </table>
    <?php
}
