...
$this->title="Kuisioner Riwayat Penyakit";
$this->registerJs("
    ...
    <div class="row">
        <div class="col-md-12">
            <?php $form = ActiveForm::begin(['id'=>'form-riwayat-penyakit','action'=>'#']); ?>
                ...
                ?>
                <a href="<?php echo $daftar['u_jenis_mcu_id']==1 ? Url::to(['kuisioner-preemployee']) : Url::to(['selesai']); ?>" class="btn btn-default btn-md btn-next" style="<?php echo $daftar['u_kuisioner2_finish_at']==NULL ? "display:none;" : "" ?>"><i class="fa fa-arrow-right"></i> Selanjutnya (<?php echo $daftar['u_jenis_mcu_id']==1 ? 'Kuisioner Anamnesa' : (!$is_reg_close ? "Selesai" : "Bukti Pendaftaran") ?>)</a>
            <?php ActiveForm::end(); ?>
        </div>
    </div>
</div>