        ...
        <div class="col-md-12">
            <?php $form = ActiveForm::begin(['id'=>$model->formName(),'action'=>'#']); ?>
                ...
                <table class="table table-bordered table-riwayat-pekerjaan">
                    ...
                    <tbody>
                        <?php echo AppUmum::riwayatSosial($kuisioner_sosial,5,false,$daftar); ?>
                    </tbody>
                </table>
                ...
                <?php endif; ?>
                <a href="<?php echo Url::to(['kuisioner-penyakit']) ?>" class="btn btn-default btn-md btn-next" style="<?php echo $model->isNewRecord ? "display:none;" : ( $daftar['u_kuisioner1_finish_at']==NULL ? "display:none;" : "" ) ?>"><i class="fa fa-arrow-right"></i> Selanjutnya (Kuisioner Riwayat Penyakit)</a>
            <?php ActiveForm::end(); ?>
        </div>
    </div>
</div>